...
export type BalanceEvent = { federationId: RpcFederationId; balance: RpcAmount }
...
export type RpcMethods = {
    ...
    usdtSupported: [usdtSupported, boolean]
    usdtStatus: [usdtStatus, RpcUsdtStatus]
    usdtBalance: [usdtBalance, RpcUsdtAmount]
    usdtGenerateDepositAddress: [usdtGenerateDepositAddress, string]
    usdtDepositStatus: [usdtDepositStatus, RpcUsdtDepositStatus]
    usdtListDeposits: [usdtListDeposits, Array<RpcUsdtDepositStatus>]
    usdtCheckDeposits: [usdtCheckDeposits, number]
    usdtRecoverDeposits: [usdtRecoverDeposits, number]
...
export type RpcUsdtDepositStatus = {
     ...
     */
    credited: RpcUsdtAmount
    /**
     * Portion already claimed into e-cash
     */
    claimed: RpcUsdtAmount
    /**
...
export type SPv2TransferState = 'initiated' | 'success' | { txRejected: string }
...
export type SocialRecoveryApproval = { guardianName: string; approved: boolean }
 ...
 */
export type UsdtDepositEvent = {
    federationId: RpcFederationId
    /**
     * 0x-prefixed deposit account address
     */
    address: string
    state: UsdtDepositState
}
 ...
 */
export type UsdtWithdrawalEvent = {
    federationId: RpcFederationId
    /**
...
export type joinFederation = { inviteCode: string; recoverFromScratch: boolean }
...
export type usdtBalance = { federationId: RpcFederationId }

export type usdtCheckDeposits = { federationId: RpcFederationId }

export type usdtDepositStatus = {
    federationId: RpcFederationId
    address: string
}
...
export type usdtStatus = { federationId: RpcFederationId }

export type usdtSupported = { federationId: RpcFederationId }

export type usdtWithdraw = {
    federationId: RpcFederationId
    recipient: string
...
export type usdtWithdrawFeeQuote = {
    federationId: RpcFederationId
    amount: RpcUsdtAmount
}

export type usdtWithdrawalStatus = {
    federationId: RpcFederationId
    txid: string
}
